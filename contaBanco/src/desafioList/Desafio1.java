...
public class Desafio1 {
		...
		/**
		 * desafio
		 * fazer um programa que receba a temperatura média dos 6 primeiros meses 
		 * e armazeneos em uma lista.
		 * apos calcule a média das temperaturas acima desta média. e em que mes ocorreram,
		 * mostrar o mes por extenso:1 - janeiro, 2 fevereiro e etc.
		 */	
